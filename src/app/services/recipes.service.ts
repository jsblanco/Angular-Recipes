...
export class RecipesService {
  recipes: Recipe[] = [
    new Recipe(
      ...
      [new Ingredient("Tomates", 3), new Ingredient("Pimientos",1), new Ingredient("Panes",2)]
    ),
    new Recipe(
      'Fabada',
      ...
      [new Ingredient("Fabas",5), new Ingredient("Chorizos",2), new Ingredient("Morcillas",2)]
    ),
    new Recipe(
      'Carrillera',
      ...
      [new Ingredient("Carrilleras",3), new Ingredient("Pimienta",1), new Ingredient("Patatas",2)]
    ),
    new Recipe(
      'Callos',
      ...
      [new Ingredient("Callos",6), new Ingredient("Pimentón",1), new Ingredient("Panes",3)]
    ),
  ];
